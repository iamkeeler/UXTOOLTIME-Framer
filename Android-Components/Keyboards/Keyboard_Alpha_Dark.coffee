...
Shift = new SVGLayer
	html: '<svg id="Shift1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 85 8.69"><title>ic_</title><path d="M-33.14,11.48H-35l3.59-3.83,3.59,3.83h-1.81v2.31h-3.55Zm-1.25,4.87h6.05V15.5h-6.05Z" transform="translate(34.96 -7.65)" style="fill:#7F8A8F"/></svg>'
	y: Align.top 142
	x: Align.left 26
